        ...
        <div class="row p-4">
            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" style="height: 350px">
                        ...
                        <img src="./img/sale13.jpg" class="d-block w-100" alt="Sales one">
                        </div>
                        <div class="carousel-item">
                        <img src="./img/sale8.jpg" class="d-block w-100" alt="Sales two">
                        </div>
                        <div class="carousel-item">
                        <img src="./img/sale5.jpg" class="d-block w-100" alt="Sales three">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                <div class="card" style="background: url('./img/auto1.jpg') no-repeat center center/cover; height: 150px;"></div>
            ...
            <div class="col-sm-2">
                <table class="table table-hover">
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                <div class="card" style="background: url('./img/auto2.jpg') no-repeat center center/cover; height: 150px;"></div>
                                <h5>Spons game <br><span style="color: red"><b>&#8358; 15,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
            ...
            <div class="col-sm-2">
                <table class="table table-hover">
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                <div class="card" style="background: url('./img/auto4.jpg') no-repeat center center/cover; height: 150px;"></div>
                                <h5>Spons game <br><span style="color: red"><b>&#8358; 15,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
            ...
            <div class="col-sm-2">
                <table class="table table-hover">
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                <div class="card" style="background: url('./img/auto5.jpg') no-repeat center center/cover; height: 150px;"></div>
                                <h5>Spons game <br><span style="color: red"><b>&#8358; 15,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
