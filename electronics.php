...
<body>
    ...
    <div class="container-fluid bg-default">
        ...
        <div class="row p-4">
            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" style="height: 350px">
                        ...
                        <img src="./img/sale12.jpg" class="d-block w-100" alt="Sales one">
                        </div>
                        <div class="carousel-item">
                        <img src="./img/sale6.jpg" class="d-block w-100" alt="Sales two">
                        </div>
                        <div class="carousel-item">
                        <img src="./img/sale10.jpg" class="d-block w-100" alt="Sales three">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- ROW 3 -->
        <div class="row p-4">
            <h2 style="text-align: center"><b>Most moving electronics sales</b></h2>
            <div class="col-sm-2">
                    ...
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                ...
                                <h5>Electronic <br><span style="color: red"><b>&#8358; 15,000</b></span></h5>
                            </a>
            ...
            <div class="col-sm-2">
                <table class="table table-hover">
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                <div class="card" style="background: url('./img/elec5.jpg') no-repeat center center/cover; height: 150px;"></div>
                                <h5>Electronic <br><span style="color: red"><b>&#8358; 20,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
                    </tr>
            ...
            <div class="col-sm-2">
                <table class="table table-hover">
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                <div class="card" style="background: url('./img/elec10.jpg') no-repeat center center/cover; height: 150px;"></div>
                                <h5>Electronic <br><span style="color: red"><b>&#8358; 130,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                ...
                                <h5>Electronic <br><span style="color: red"><b>&#8358; 105,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
                    </tr>
            ...
            <div class="col-sm-2">
                <table class="table table-hover">
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                <div class="card" style="background: url('./img/elec20.jpg') no-repeat center center/cover; height: 150px;"></div>
                                <h5>Electronic <br><span style="color: red"><b>&#8358; 500,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                ...
                                <h5>Electronic <br><span style="color: red"><b>&#8358; 60,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
                    </tr>
            ...
            <div class="col-sm-2">
                <table class="table table-hover">
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                <div class="card" style="background: url('./img/elec16.jpg') no-repeat center center/cover; height: 150px;"></div>
                                <h5>Electronic <br><span style="color: red"><b>&#8358; 210,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
                    </tr>
            ...
            <div class="col-sm-2">
                <table class="table table-hover">
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                <div class="card" style="background: url('./img/elec12.jpg') no-repeat center center/cover; height: 150px;"></div>
                                <h5>Electronic <br><span style="color: red"><b>&#8358; 90,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
                    </tr>
            ...
            <div class="col-sm-2">
                <table class="table table-hover">
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                <div class="card" style="background: url('./img/elec3.jpg') no-repeat center center/cover; height: 150px;"></div>
                                <h5>Electronic <br><span style="color: red"><b>&#8358; 40,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
                    </tr>
            ...
            <div class="col-sm-2">
                <table class="table table-hover">
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                <div class="card" style="background: url('./img/elec13.jpg') no-repeat center center/cover; height: 150px;"></div>
                                <h5>Electronic <br><span style="color: red"><b>&#8358; 211,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                ...
                                <h5>Electronic <br><span style="color: red"><b>&#8358; 22,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
                    </tr>
            ...
            <div class="col-sm-2">
                <table class="table table-hover">
                    <tr>
                        <td>
                            <a href="#" class="text-decoration-none" style="color: black">
                                <div class="card" style="background: url('./img/elec4.jpg') no-repeat center center/cover; height: 150px;"></div>
                                <h5>Electronic <br><span style="color: red"><b>&#8358; 56,000</b></span></h5>
                            </a>
                            <button class="btn btn-outline-danger" type="submit">Add to Cart <i class="fas fa-shopping-cart"></i></button>
                        </td>
                    </tr>
        ...
        <div class="row p-4">
            <div class="col-md-6">
                <div class="card" style="background: url('./img/sale14.jpg') no-repeat center center/cover; height: 200px;">
                </div>
            </div>
            <div class="col-md-6">
                    <div class="card" style="background: url('./img/sale3.jpg') no-repeat center center/cover; height: 200px;">
                        <!-- <div class="card-body">
